program make_table
  ...
  real(8),allocatable :: time_temp_traj_list(:,:),ye_temp_traj_list(:,:),mass_temp_traj_list(:,:),eta_temp_traj_list(:,:),sen_temp_traj_list(:,:),texp_temp_traj_list(:,:)
  ...
  integer :: nunit, nunit_time, nunit_ye, nunit_eta, nunit_entr, nunit_texp, nunit_rcap, nunit_yecap
  integer :: i
...
!!! collapsar in 2D
  ...
  allocate( time_temp_traj_list(ntemp,np),ye_temp_traj_list(ntemp,np),mass_temp_traj_list(ntemp,np),eta_temp_traj_list(ntemp,np),sen_temp_traj_list(ntemp,np),texp_temp_traj_list(ntemp,np) )
...
999        continue
        ...
        if(.not.output_once)then
           i = idx
           write(nunit_time,'(" ", i15,99es15.7)') ip_list(i), mass_list(i), (time_temp_traj_list(itemp,i),itemp=1,ntemp)
           
           write(nunit_ye,'(" ", i15,99es15.7)') ip_list(i), mass_list(i), (ye_temp_traj_list(itemp,i),itemp=1,ntemp)
           
           write(nunit_eta,'(" ", i15,99es15.7)') ip_list(i), mass_list(i), (eta_temp_traj_list(itemp,i),itemp=1,ntemp)
           
           write(nunit_entr,'(" ", i15,99es15.7)') ip_list(i), mass_list(i), (sen_temp_traj_list(itemp,i),itemp=1,ntemp)
           
           write(nunit_texp,'(" ", i15,99es15.7)') ip_list(i), mass_list(i), (texp_temp_traj_list(itemp,i),itemp=1,ntemp)
           
           write(nunit_rcap,'(" ", i15,99es15.7)') ip_list(i), mass_list(i), (caprate_temp_traj_list(itemp,i),itemp=1,ntemp)
           
           write(nunit_yecap,'(" ", i15,99es15.7)') ip_list(i), mass_list(i), (yecap_temp_traj_list(itemp,i),itemp=1,ntemp)
        endif
  ...
  if(output_once)then
    ...
    ! write(nunit,'(" ", 15x,15x,99es15.7)') (temp_list(itemp),itemp=1,ntemp)
    ! do i=1,idx
    !    write(nunit,'(" ", i15,99es15.7)') ip_list(i), mass_list(i), (yemu0_temp_traj_list(itemp,i),itemp=1,ntemp)
    ! enddo
    ! close(nunit)
